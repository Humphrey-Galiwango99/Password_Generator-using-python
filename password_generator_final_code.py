...
# print(f'these are the alphebets of the english lang. {all_alphabets}')

all_digits = list(string.digits)
# print(f'These are the numbers in english lang: {all_digits}')

all_symbols = list(string.punctuation)
# print(f'These are all the symbols: in the english lang: {all_symbols}')
...
for number in range(no_of_letters):
    ...
    password_character_list.append(random.choice(all_alphabets))
...
for number in range(no_of_symbols):
    ...
    password_symbol_list.append(random.choice(all_symbols))
...
for number in range(no_of_digits):
    ...
    password_digit_list.append(random.choice(all_digits))
...
final_password_list = ''.join(final_password_list)
